...
def mnist():
    ...
    train_path = r"C:\..\dtu_MLops_answers\S1\final_exercise\data\data_corrupt\corruptmnist\train_"
    test_path = r"C:\..\dtu_MLops_answers\S1\final_exercise\data\data_corrupt\corruptmnist\test.npz"
